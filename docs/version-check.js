...
function loadMainApp() {
  ...
  // 🚨 THE FIX: ADDED STAFF ROUTING
  else if (currentPage.includes("staff")) {
    appFile = "staffApp.js";
  }

  // 🚨 THE FIX: ADDED ACCOUNTANT ROUTING (Based on your signin.js roles)
  else if (currentPage.includes("accountant")) {
    appFile = "accountantApp.js"; // Adjust this filename if it's different
  }
